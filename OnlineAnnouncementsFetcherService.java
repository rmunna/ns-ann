...
@Service
public class OnlineAnnouncementsFetcherService {
    // RSS feed URL for Online Announcements
    private final String RSS_FEED_URL = "https://nsearchives.nseindia.com/content/RSS/Online_announcements.xml";

    public List<RssItem> fetchOnlineAnnouncements() {
